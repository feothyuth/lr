...
pub struct Trade {
    ...
    pub timestamp: i64,
    #[serde(rename = "taker_fee", default)]
    pub taker_fee: i32,
    ...
    #[serde(rename = "taker_initial_margin_fraction_before", default)]
    pub taker_initial_margin_fraction_before: i32,
    #[serde(rename = "taker_position_sign_changed", default)]
    pub taker_position_sign_changed: bool,
    #[serde(rename = "maker_fee", default)]
    pub maker_fee: i32,
    ...
    #[serde(rename = "maker_initial_margin_fraction_before", default)]
    pub maker_initial_margin_fraction_before: i32,
    #[serde(rename = "maker_position_sign_changed", default)]
